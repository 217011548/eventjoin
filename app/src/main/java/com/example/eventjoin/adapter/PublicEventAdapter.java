...
public class PublicEventAdapter extends BaseAdapter {
    List<Event> events=new ArrayList<>();
    LayoutInflater linf;
    public PublicEventAdapter(Context c, List<Event> events){
        this.events = events;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        View v=linf.inflate(R.layout.event_list_public,null);
